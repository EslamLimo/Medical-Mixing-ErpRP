        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WalletType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsWalletTransaction = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountTransactions_SupplierCustomers_SupplierCustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RawItems_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Commissions_SalesReps_SalesRepId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackingCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PackingDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackingTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackingTransactions_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    SupplierCustomerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingTransactions_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShippingTransactions_ShippingCompanies_ShippingCompanyId",
                        column: x => x.ShippingCompanyId,
                        principalTable: "ShippingCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShippingTransactions_SupplierCustomers_SupplierCustomerId",
                        column: x => x.SupplierCustomerId,
                        principalTable: "SupplierCustomers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompositionRawItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompositionRawItems_Compositions_CompositionId",
                        column: x => x.CompositionId,
                        principalTable: "Compositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompositionRawItems_RawItems_RawItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehouseId = table.Column<int>(type: "int", nullable: false),
                    RawItemId = table.Column<int>(type: "int", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_RawItems_RawItemId",
                        column: x => x.RawItemId,
                        principalTable: "RawItems",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountTransactions_SupplierCustomerId",
                table: "AccountTransactions",
                column: "SupplierCustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commissions_SalesRepId",
                table: "Commissions",
                column: "SalesRepId");

            migrationBuilder.CreateIndex(
                name: "IX_CompositionRawItems_CompositionId",
                table: "CompositionRawItems",
                column: "CompositionId");

            migrationBuilder.CreateIndex(
                name: "IX_CompositionRawItems_RawItemId",
                table: "CompositionRawItems",
                column: "RawItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_RawItemId",
                table: "InventoryTransactions",
                column: "RawItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackingTransactions_ProductId",
                table: "PackingTransactions",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawItems_WarehouseId",
                table: "RawItems",
                column: "WarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingTransactions_ProductId",
                table: "ShippingTransactions",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingTransactions_ShippingCompanyId",
                table: "ShippingTransactions",
                column: "ShippingCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingTransactions_SupplierCustomerId",
                table: "ShippingTransactions",
                column: "SupplierCustomerId");
